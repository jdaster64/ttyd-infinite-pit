...
const uint32_t kPitCharlietonMinItemToDisplayBadgeTextOffset = 0x11b1c;
const uint32_t kPitCharlietonPouchAddItemCallOffset = 0x11c60;
const uint32_t kPitCharlietonPouchAddItemCheckOffset = 0x11c70;
