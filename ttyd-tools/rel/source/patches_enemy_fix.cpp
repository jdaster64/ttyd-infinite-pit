...
extern const uint32_t g_jon_BanditAttackEvt_CheckConfusionOffset;
extern const uint32_t g_jon_DarkKoopatrolAttackEvt_NormalAttackReturnLblOffset;
extern const uint32_t g_jon_DarkWizzerdAttackEvt_CheckEnemyNumOffset;
extern const uint32_t g_jon_DarkWizzerdGaleForceDeathEvt_PatchOffset;
extern const uint32_t g_jon_EliteWizzerdAttackEvt_CheckEnemyNumOffset;
extern const uint32_t g_jon_EliteWizzerdGaleForceDeathEvt_PatchOffset;
