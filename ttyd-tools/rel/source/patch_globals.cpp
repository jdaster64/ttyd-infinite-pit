...
extern const int32_t g_jon_idouya_setup_MoverLastSpawnFloorOffset = 0x119a0;
...
extern const uint32_t g_jon_BanditAttackEvt_CheckConfusionOffset = 0x2ffa8;
extern const uint32_t g_jon_DarkKoopatrolAttackEvt_NormalAttackReturnLblOffset = 0x51790;
extern const uint32_t g_jon_DarkWizzerdAttackEvt_CheckEnemyNumOffset = 0x535a4;
extern const uint32_t g_jon_DarkWizzerdGaleForceDeathEvt_PatchOffset = 0x544e4;
extern const uint32_t g_jon_EliteWizzerdAttackEvt_CheckEnemyNumOffset = 0x5cecc;
extern const uint32_t g_jon_EliteWizzerdGaleForceDeathEvt_PatchOffset = 0x5de0c;
extern const uint32_t g_jon_BadgeBanditAttackEvt_CheckConfusionOffset = 0x73e40;
extern const uint32_t g_jon_PiderGaleForceDeathEvt_PatchOffset = 0x760e4;
extern const uint32_t g_jon_ArantulaGaleForceDeathEvt_PatchOffset = 0x79ec4;
