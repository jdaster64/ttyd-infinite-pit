### Paper Mario: TTYD Infinite Pit Mod (v1.04.1 r30) by Jdaster64
...
*   Seeding might sometimes be inconsistent after reloading a save; haven't
    been able to reproduce the issue. (Might be fixed by 1.03)
